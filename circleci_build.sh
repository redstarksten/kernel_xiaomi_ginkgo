...
export PATH="$HOME/project/clang/bin:$PATH"
export LD_LIBRARY_PATH="$HOME/project/clang/lib:$LD_LIBRARY_PATH"
export CROSS_COMPILE="$HOME/project/clang/bin/aarch64-linux-android-"
export CROSS_COMPILE_ARM32="$HOME/project/clang/bin/arm-linux-androideabi-"
